          ...
          {currentEquipments.map((item) => {
            ...
            return (
              <div
                ...
                className="flex flex-col items-center gap-2 sm:gap-4 p-2.5 sm:p-3.5 rounded-xl bg-[#FDFBF7]/60 border border-stone-100 transition-all duration-300 hover:border-[#D4AF37]/40 hover:bg-white hover:shadow-sm group"
              >
